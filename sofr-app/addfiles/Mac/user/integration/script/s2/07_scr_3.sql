--задание планировщику TomCat uTableProcessEvent_dbt
DECLARE
...
3 - с учетом выходных
*/
v_SimpleServiceId := 10002;
v_SServiceName := 'Обработчик событий uTableProcessEvent_dbt';
v_SServiceDesctiption := 'Процедура синхронизации данных объектов СОФР';
...
v_Exec_Func := 'ws_check_job_Event';
