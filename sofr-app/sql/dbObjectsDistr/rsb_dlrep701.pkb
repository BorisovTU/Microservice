CREATE OR REPLACE PACKAGE BODY rsb_dlrep701
IS /* Тело пакета rsb_dlrep701 */ 
  ...
  IS
     ...
     v_owner_BIC NUMBER;
  BEGIN
     FOR one_rec IN ( select NDEAL.T_ID, NDEAL.T_DOCKIND, NDEAL.T_SECTOR, NDEAL.T_DVKIND, NDEAL.T_TYPE, NDEAL.T_DATE, NDEAL.T_CLIENT, NDEAL.T_Contractor, NDEAL.T_OptionType,
