...
BEGIN
  ...
  addGTKOPRM(53, 'RGDVNDL_TRADERCODE'); 	-- для внебиржевой сделки с ПИ
  addGTKOPRM(54, 'RGDVFXDL_TRADERCODE'); 	-- добавление параметра RGDVRQ_TRADERCODE в таблицу dgtkoprm_dbt
