...
BEGIN
   INSERT INTO DOBJGROUP_DBT (T_OBJECTTYPE, T_GROUPID, T_TYPE, T_NAME, T_SYSTEM, T_ORDER, T_MACRONAME, T_KEEPOLDVALUES,
                      ...
                      VALUES (133,101,'X','Корректировка выгружена в файл',CHR(0),1,CHR(1),'X',0,CHR(0),0,0,CHR(0),CHR(0),CHR(0),CHR(0),CHR(0),CHR(0),CHR(1));
...
BEGIN
   ...
   INSERT INTO DOBJATTR_DBT (T_OBJECTTYPE, T_GROUPID, T_ATTRID, T_PARENTID, T_CODELIST, T_NUMINLIST, T_NAMEOBJECT, T_CHATTR, T_LONGATTR, T_INTATTR,
                      ...
                      VALUES (133,101,1,0,'1','1','1',CHR(0),0,0,'Да','Да',TO_DATE('01.01.0001:00:00:00','DD.MM.YYYY HH24:MI:SS'),TO_DATE('01.01.0001:00:00:00','DD.MM.YYYY HH24:MI:SS'),0,CHR(1),CHR(1),CHR(0));
...
BEGIN
  INSERT INTO DNOTEKIND_DBT(T_OBJECTTYPE, T_NOTEKIND, T_NOTETYPE, T_NAME, T_KEEPOLDVALUES, T_NOTINUSE, T_ISPROTECTED,
              ...
              VALUES(133,101,7,'Признак выгрузки корректировки в файл',CHR(0),CHR(0),CHR(0),0,CHR(0),CHR(1),0,CHR(0));
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
