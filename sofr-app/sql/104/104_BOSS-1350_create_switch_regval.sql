-- Изменения по BOSS-1350
-- Добавление настройки 'РСХБ/ИНТЕГРАЦИЯ/РУБИЛЬНИК-BOSS-1350'
DECLARE
  logID VARCHAR2(32) := 'BOSS-1350_DEF-65583';
  ...
  END;
BEGIN
  -- Добавление настройки (настройка добавляется в ВЫКЛЮЧЕННОМ состоянии)
  AddReg( 'РСХБ/ИНТЕГРАЦИЯ', 'РУБИЛЬНИК-BOSS-1350', 'использовать автоматическое исполнение операций зачислений ц/б', '' );
EXCEPTION
  WHEN OTHERS THEN
