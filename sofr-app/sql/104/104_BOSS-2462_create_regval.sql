-- Изменения по BOSS-2056_BOSS-2462
-- Добавление настройки 'РСХБ/ИНТЕГРАЦИЯ/СВЕРКА_ПРОВОДОК_ЦФТ_24'
DECLARE
  logID VARCHAR2(32) := 'BOSS-2056_BOSS-2462';
...
BEGIN
  ...
  AddReg( 'РСХБ/ИНТЕГРАЦИЯ', 'СВЕРКА_ПРОВОДОК_ЦФТ_24', 'использовать отчет-сверку проводок ЦФТ 24', '' );
EXCEPTION
  WHEN OTHERS THEN
