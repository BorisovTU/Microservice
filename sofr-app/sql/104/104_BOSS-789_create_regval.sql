-- Изменения по BOSS-789_BOSS-2514
-- Добавление настройки 'РСХБ/ИНТЕГРАЦИЯ/CHECK_WRITEOFF'
DECLARE
  logID VARCHAR2(32) := 'BOSS-789_BOSS-2514';
...
BEGIN
  ...
  AddReg( 'РСХБ/ИНТЕГРАЦИЯ', 'CHECK_WRITEOFF', 'проверка для автоматизации списаний цб', '' );
EXCEPTION
  WHEN OTHERS THEN
