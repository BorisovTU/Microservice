...
BEGIN
  ...
  CHR(0),CHR(0),'Отправка неторгового поручения в QUIK',0,CHR(0),CHR(0),CHR(0),0,
...
BEGIN
  ...
  CHR(0),CHR(0),'Получение результата обработки неторгового поручения в QUIK',0,CHR(0),CHR(0),CHR(0),0,
  CHR(0),CHR(88),CHR(1),0,CHR(0),0,CHR(0),0,CHR(0),CHR(0),CHR(88),0);
