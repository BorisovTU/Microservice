...
begin
   ...
   if v_cnt = 0 then
    Insert into DOBJGROUP_DBT
     ...
     Values
       (v_objecttype, v_groupid, chr(88), 'TRD_REST', '', 
    ...
    Insert into DOBJATTR_DBT
     ...
     Values
       (v_objecttype, v_groupid, 1, 0, chr(1), 
        '1', '1', chr(0), 0, 0, 
        'Сделки только с недружественными нерезидентами', 'Сделки только с недружественными нерезидентами', TO_DATE('01/01/0001 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('01/01/0001 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 0, 
        chr(1), chr(1), chr(0));
    ...
    Insert into DOBJATTR_DBT
     ...
     Values
       (v_objecttype, v_groupid, 2, 0, chr(1), 
        '2', '2', chr(0), 0, 0, 
        'Сделки только с резидентами', 'Сделки только с резидентами', TO_DATE('01/01/0001 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), TO_DATE('01/01/0001 00:00:00', 'MM/DD/YYYY HH24:MI:SS'), 0, 
        chr(1), chr(1), chr(0));
