...
-- Добавление настройки 'РСХБ/ИНТЕГРАЦИЯ/СВЕРКА_ОСНОВАНИЯ_ПРОВОДОК'
DECLARE
...
BEGIN
  ...
  AddReg( 'РСХБ/ИНТЕГРАЦИЯ', 'СВЕРКА_ОСНОВАНИЯ_ПРОВОДОК', 'проверять основание при сверке проводок с ЦФТ 24', '' );
EXCEPTION
  WHEN OTHERS THEN
