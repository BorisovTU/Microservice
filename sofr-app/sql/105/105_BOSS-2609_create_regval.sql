-- Изменения по BOSS-2609_BOSS-2845
-- Добавление настройки 'SECUR/BLOCKED_OTC_DEALS_IMPORT'
DECLARE
  logID VARCHAR2(32) := 'BOSS-2609_BOSS-2845';
...
BEGIN
  ...
  AddReg( 'SECUR', 'BLOCKED_OTC_DEALS_IMPORT', 'загрузка сделок BlockedOTC', '' );
EXCEPTION
  WHEN OTHERS THEN
