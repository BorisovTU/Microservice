...
BEGIN
 ...
 sql_statement := 
                 ...
                 WHERE party.t_partyid= part.t_partyid AND party.t_partyid ='||Clientid||' and part.t_partykind = 1 AND EXISTS (SELECT 1 FROM dpersn_dbt WHERE party.t_partyid = T_PERSONID)';
