...
BEGIN
  ...
  AlterThisTable('DDLCLBOAVOIR_DBT', 'T_COURSE', 'NUMBER(32,12)', 'DEFAULT 0');
  AlterThisTable('DDLCLBOAVOIR_DBT', 'T_NKD', 'NUMBER(32,12)', 'DEFAULT 0');
  AlterThisTable('DDLCLBOAVOIR_DBT', 'T_COURSEFI', 'NUMBER(10,0)', 'DEFAULT 0');
EXCEPTION
  WHEN OTHERS THEN
