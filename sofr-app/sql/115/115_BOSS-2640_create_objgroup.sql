declare
  ...
  v_groupid  number   := 112; 
  v_name varchar2(249) := 'Зарегистрирован в государстве - члене ЕАЭС';
  ...
  select count(*) into v_cnt
   ...
   if v_cnt = 0 then
    Insert into DOBJGROUP_DBT
     ...
     Values
       (v_objecttype, v_groupid, 'X', v_name, '', 
    ...
    Insert into DOBJFIELDUSE_DBT
      (T_OBJECTTYPE, T_OBJECTFIELDTYPE, T_OBJECTFIELDID, T_USEID, T_PARENTUSEID, T_COMPLEXPARENTUSEID, T_USECODE, T_USENAME, T_USEOPERATOR, T_USEVALUE)
    Values
      (v_objecttype, 1, v_groupid, 0, 0, 
       0, 'СЭРоль', 'Роль', '=', 'Эмитент ценных бумаг');
