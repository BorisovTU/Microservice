DECLARE
   ...
   C_CASEITEM            NUMBER := 20248;  --Номер модуля
   C_NAME                VARCHAR2 (255) := 'Форма 6-НДФЛ 2025 г.';
...
BEGIN
   ...
   INSERT INTO DITEMSYST_DBT(T_CIDENTPROGRAM,T_ICASEITEM,T_IKINDMETHOD,T_IKINDPROGRAM,T_IHELP,T_RESERVE,T_SZNAMEITEM,T_PARM )
               VALUES('S',C_CASEITEM,1,2,0,CHR(1),C_NAME,'');
               
   --Для пользователей ролей
   FOR i IN (SELECT DISTINCT T_OPER
               FROM DACSOPROLE_DBT rol
              WHERE ROL.T_ROLEID IN (1, 10010/*[10] Прикладной администратор*/, 10014 /*[14] Специалист БО*/))
   LOOP
