...
BEGIN
  ...
  VALUES(0,v_ParentID,'ПРЕДЕЛЬНЫЙ_СРОК_ВОЗВРАТА_НАЛОГА',0,'X','Предельный срок возврата налога. Значение указывается в днях.',CHR(0),CHR(0),CHR(1)) returning T_KEYID INTO v_ID;
