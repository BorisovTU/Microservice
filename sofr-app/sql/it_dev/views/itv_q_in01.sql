create or replace view itv_q_in01 as
select q.q_name queuename -- Входящие сообщения очереди 01
      ,q.msgid qmsgid
      ,q.state
  ...
  from itt_queue_in_01 q
 where q.q_name = 'ITQ_IN_01' with read only
/ 
