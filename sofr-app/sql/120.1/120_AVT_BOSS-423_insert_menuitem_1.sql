/*Добавить системные модули*/
BEGIN
   INSERT INTO DITEMSYST_DBT(T_CIDENTPROGRAM,T_ICASEITEM,T_IKINDMETHOD,T_IKINDPROGRAM,T_IHELP,T_RESERVE,T_SZNAMEITEM,T_PARM )
               VALUES('S',26115,1,2,0,CHR(1),'Шаблоны клиентских уведомлений','');
...
DECLARE
   ...
   C_CASEITEM            NUMBER := 26115;  --Номер модуля
   C_NAME                VARCHAR2 (255) := 'Шаблоны клиентских уведомлений';
