...
BEGIN
  ...
  VALUES(0,v_ParentID,'УЧЕТ_КУП_ДЕПО_ПРИ_РАСЧ_НОБ',4,'X','Необходимость учета купонных выплат Депозитария при расчете НОБ с типом "Окончание года"',CHR(0),CHR(0),CHR(1)) returning T_KEYID INTO v_ID;
