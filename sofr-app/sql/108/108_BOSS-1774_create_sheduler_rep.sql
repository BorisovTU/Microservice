...
begin
    ...
    values (v_id, --t_id
            'Ежедневный отчет по обработке выплат из Диасофта', --t_name
            'Ежедневный отчет по обработке выплат из Диасофта при погашении ц/б', --t_description
            'X' --t_isactive
            );
    ...
    values ( v_id_d, --t_id
             ...
             'Ежедневный отчет по обработке выплат из Диасофта', --t_name
             1, --t_type
             'cdrecords_rep.mac', --t_executorname
             'CreateCdRecordsRep', --t_executorfunc
             0, --t_startdelay,
             0, --t_period
             1, --t_maxattempt,
             0, --t_timeout
