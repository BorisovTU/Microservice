BEGIN
   FOR rec
      IN (SELECT r1.t_OtherFI, r1.t_rateid, r2.t_rateid t_rateid_rub, r1.T_ISINVERSE, r1.T_RATE, r1.T_SCALE, r1.T_POINT, r1.T_INPUTDATE, r1.T_INPUTTIME, r1.T_OPER, r1.T_SINCEDATE, r1.T_ISMANUALINPUT, 
           ...
           WHERE r1.t_Type IN (34)                             -- Расчётная цена для главы Г
             AND r1.t_Type = r2.t_Type                         -- Одинаковый вид курса
             AND r1.t_FIID != r2.t_FIID                        -- Разный котируемый ФИ
             AND r1.t_FIID != 0                                -- Не рубли, т.е. неправильный
             ...
             AND fin.t_FIID IN (select t_FIID from dfininstr_dbt subfin where subfin.t_facevaluefi  IN (76813) and subfin.t_drawingdate >= TO_DATE('01/01/2024 00:00:00', 'MM/DD/YYYY HH24:MI:SS')) )
