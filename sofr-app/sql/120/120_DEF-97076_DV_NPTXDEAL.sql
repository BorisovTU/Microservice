...
AS
   (SELECT lot.t_ID,
           ...
           lot.t_Contract,
           NVL ((select contr.t_number from ddlcontr_dbt dl, DDLCONTRMP_DBT mp, dsfcontr_dbt contr where mp.T_SFCONTRID = lot.t_Contract and mp.T_DLCONTRID = dl.T_DLCONTRID and dl.T_SFCONTRID = contr.t_ID), CHR (1)) ,
           lot.t_FIID,
