...
begin
  create_funcobj(p_code => 'SecRedemptPerson',
                 p_name => 'Исполнение операции погашения ц/б',
                 p_file => 'SecurRedemptionProcessor.mac',
                 p_func => 'SecurRedemptionPersonalProcessorFuncObj',
                 p_priority => 31);
end;
/