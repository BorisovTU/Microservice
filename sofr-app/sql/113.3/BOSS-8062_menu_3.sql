...
begin
  ...
  it_rs_interface.add_menu_item_oper (
       ...
       ,p_menu_item       => 'Š®àà¥ªâ¨à®¢ª  £à ä¨ª  á¤¥«®ª'
       ,p_menu_nameprompt => 'Š®àà¥ªâ¨à®¢ª  £à ä¨ª  á¤¥«®ª'
       ,p_usermodule_name => 'Š®àà¥ªâ¨à®¢ª  £à ä¨ª  á¤¥«®ª'
       ,p_usermodule_file => 'SecurOTCUpdDealScheduleUI.mac'
