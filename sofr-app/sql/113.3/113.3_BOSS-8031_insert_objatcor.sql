--Не отделять сделки замещения ЦБ из тарификации
BEGIN
  ...
  (SELECT 57, 105, 1, LPAD(T_SFPLANID, 10, '0'), CHR(88), TO_DATE('01/01/0001','DD/MM/YYYY'), 1, TO_DATE('31/12/9999','DD/MM/YYYY'), CHR(88)
