DECLARE
   ...
   C_CASEITEM            NUMBER := 20255;  --Номер модуля
   C_NAME                VARCHAR2 (255) := 'Таблица соответствия кодов доходов и вычетов';
...
BEGIN
   ...
   FOR i IN (SELECT DISTINCT T_OPER
              ...
              WHERE ROL.T_ROLEID IN (1, 10010/*[10] Прикладной администратор*/,10036/*[36] Ответственный сотрудник НДФЛ*/, 10014 /*[14] Специалист БО*/))
   LOOP
   ...
   FOR i IN (SELECT DISTINCT T_MENUID
              ...
              WHERE ROL.T_ROLEID IN (1, 10010/*[10] Прикладной администратор*/,10036/*[36] Ответственный сотрудник НДФЛ*/, 10014 /*[14] Специалист БО*/)) LOOP
