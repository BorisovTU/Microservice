...
declare
  ...
  /* 
                            ...
                            Ь Шлюз
  */
  menu_path       varchar2(256) := 'Сервисные операции\Лимиты QUIK'; -- путь к пункту меню c разделителем \
  menu_item       varchar2(128) := 'Блокировка договоров'; -- Имя пункта.
  menu_nameprompt varchar2(256) := 'Блокировка договоров по списку'; -- Описание.
  usermodule_name varchar2(128) := 'Блокировка договоров по списку'; -- Наименование пользовательского модуля 
  usermodule_file varchar2(128) := 'blockunlock.mac'; -- Наименование макроса 
