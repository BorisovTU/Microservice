...
BEGIN
   ...
   IF (:new.t_State = 2 AND (:new.t_Service = 10099 OR :new.t_Service = 10052 OR :new.t_Service = 10070 OR :new.t_Service = 10002 OR :new.t_Service = 10003 OR :new.t_Service = 10014 OR :new.t_Service = 10045 OR :new.t_Service = 10023) ) THEN
     :new.t_State := 3;
