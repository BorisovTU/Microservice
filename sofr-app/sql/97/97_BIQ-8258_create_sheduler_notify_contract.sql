...
begin
    ...
    values (v_id, --t_id
            'Уведомления о необход. предостав. док. по ИИС', --t_name
            'Рассылка уведомлений о необходимости предоставить документы по ИИС', --t_description
            'X' --t_isactive
            );
