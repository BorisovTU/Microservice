...
BEGIN
   INSERT INTO DITEMSYST_DBT(T_CIDENTPROGRAM,T_ICASEITEM,T_IKINDMETHOD,T_IKINDPROGRAM,T_IHELP,T_RESERVE,T_SZNAMEITEM,T_PARM )
               VALUES('S',20209,1,2,0,CHR(1),'Отчет по СНОБ и удержанному НДФЛ','');
...
DECLARE
   ...
   C_NAME                VARCHAR2 (255) := 'Отчеты';
   V_NUMBERFATHER        NUMBER := 0;
   C_NUMBERLINE          NUMBER := 100;
...
DECLARE
   ...
   C_IDENTPROGRAM_CODE   NUMBER := 83; --Подсистема
   C_CASEITEM            NUMBER := 20209;  --Номер модуля
   C_NAME                VARCHAR2 (255) := 'Отчет по СНОБ и удержанному НДФЛ';
   V_NUMBERFATHER        NUMBER := 0;
