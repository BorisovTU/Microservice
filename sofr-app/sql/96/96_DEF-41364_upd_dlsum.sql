...
BEGIN
   ...
   SELECT 0,                     
    ...
    WHERE tk.t_BOfficeKind = opr.t_DocKind
      ...
      AND dls_cost.t_Sum <> ROUND(dls_price.t_Sum*leg.t_Principal, 2)
      AND NOT EXISTS(SELECT 1 FROM ddlsum_dbt dls1 WHERE dls1.t_DocKind = dls_cost.t_DocKind AND dls1.t_DocID = dls_cost.t_DocID AND dls1.t_Kind = -1*dls_cost.t_Kind);
