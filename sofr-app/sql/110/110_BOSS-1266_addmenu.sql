-- Изменения по BOSS-1266_BOSS-5396
-- Создание пункта меню '[13408] Сверка зачислений и списаний ДС СОФР_ЦФТ'
DECLARE
  logID VARCHAR2(32) := 'BOSS-1266_BOSS-5396';
...
BEGIN
  ...
  AddMenu(
    ...
    , 'Отчеты\РСХБ'    	         				-- путь к пункту меню c разделителем \
    , '[13408] Сверка зачислений и списаний ДС СОФР_ЦФТ' 	-- Имя пункта.
    , '[13408] Сверка зачислений и списаний ДС СОФР_ЦФТ' 	-- Описание.
    , '[13408] Сверка зачислений и списаний ДС СОФР_ЦФТ' 	-- Наименование пользовательского модуля 
    , 'uentcompare_dlg1266.mac'					-- Наименование макроса 
