DECLARE
   ...
   C_CASEITEM            NUMBER := 20250;  --Номер модуля
   C_NAME                VARCHAR2 (255) := 'Список настроек для налогового учета';
...
BEGIN
   ...
   FOR i IN (SELECT DISTINCT T_OPER
              ...
              WHERE ROL.T_ROLEID IN (1, 10036 /*116_BOSS-7697_create_dregparmstory_dbt.sql*/))
   LOOP
   ...
   FOR i IN (SELECT DISTINCT T_MENUID
              ...
              WHERE ROL.T_ROLEID IN (1, 10036 /*116_BOSS-7697_create_dregparmstory_dbt.sql*/)) LOOP
