DECLARE
   ...
   C_CASEITEM            NUMBER := 20227; --Номер модуля
   C_NAME                VARCHAR2(255) := 'Автоматический вынос задолженности на просрочку';
   V_NUMBERFATHER        NUMBER := 0;
   C_NUMBERLINE          NUMBER := 470;
...
BEGIN
   INSERT INTO DITEMSYST_DBT(T_CIDENTPROGRAM,T_ICASEITEM,T_IKINDMETHOD,T_IKINDPROGRAM,T_IHELP,T_RESERVE,T_SZNAMEITEM,T_PARM)
               VALUES('S',C_CASEITEM,1,2,0,CHR(1),C_NAME,'');
