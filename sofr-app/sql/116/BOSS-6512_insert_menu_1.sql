...
begin
  ...
  it_rs_interface.add_menu_item_oper (
       ...
       ,p_menu_item       => '“à¥£. ®áâ âª®¢ ­  áç¥â å „”‹ ª ¢®§¢à. ¢ ¤ âã à¥§¥à¢.'
       ,p_menu_nameprompt => '“à¥£ã«¨à®¢ ­¨¥ ®áâ âª®¢ ­  áç¥â å „”‹ ª ¢®§¢à âã ¢ ¤ âã à¥§¥à¢¨à®¢ ­¨ï'
       ,p_usermodule_name => '“à¥£. ®áâ âª®¢ ­  áç¥â å „”‹ ª ¢®§¢à. ¢ ¤ âã à¥§¥à¢.'
       ,p_usermodule_file => 'nptxadjres_munerun.mac'
       ,pt_objectid       => l_object
       ,p_inumberline     => 30
    );
end;