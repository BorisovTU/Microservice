...
begin
  g_service_name := 'Загрузка данных QUIK из буфферных таблиц в СОФР';
  ...
  create_service(p_id         => g_service_id,
                 ...
                 p_end        => to_date('01.01.0001 23:59:00', 'dd.mm.yyyy hh24:mi:ss'),
                 p_periodtype => 2, --минуты
                 p_period     => 30, --раз в 30 минут
                 p_macrofile  => 'ws_check_job.mac',
                 p_macrofunc  => 'ws_SOFR_AssetLimits');
end;
/