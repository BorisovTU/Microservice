/*Заполнить коды ОКАТО для клиентов*/
...
BEGIN
    EXECUTE IMMEDIATE 'DROP INDEX DOBJCODE_DBT_IDXC';
EXCEPTION 
...
CREATE INDEX DOBJCODE_DBT_IDXC ON DOBJCODE_DBT (DECODE(T_STATE,1,NULL,DECODE(T_OBJECTTYPE,3,DECODE(T_CODEKIND,16,NULL,27,NULL,12,NULL,68,NULL,73,NULL,TO_CHAR(T_OBJECTTYPE)),9,DECODE(T_CODEKIND,18,NULL,TO_CHAR(T_OBJECTTYPE)),207,DECODE(T_CODEKIND,1,NULL,TO_CHAR(T_OBJECTTYPE)),TO_CHAR(T_OBJECTTYPE))), DECODE(T_STATE,1,NULL,DECODE(T_OBJECTTYPE,3,DECODE(T_CODEKIND,16,NULL,27,NULL,12,NULL,68,NULL,73,NULL,TO_CHAR(T_CODEKIND)),9,DECODE(T_CODEKIND,18,NULL,TO_CHAR(T_CODEKIND)),207,DECODE(T_CODEKIND,1,NULL,TO_CHAR(T_CODEKIND)),TO_CHAR(T_CODEKIND))), DECODE(T_STATE,1,NULL,DECODE(T_OBJECTTYPE,3,DECODE(T_CODEKIND,16,NULL,27,NULL,12,NULL,68,NULL,T_CODE),9,DECODE(T_CODEKIND,18,NULL,T_CODE),207,DECODE(T_CODEKIND,1,NULL,T_CODE),T_CODE)), DECODE(T_STATE,1,NULL,DECODE(T_OBJECTTYPE,3,DECODE(T_CODEKIND,16,NULL,27,NULL,12,NULL,68,NULL,TO_CHAR(T_STATE)),9,DECODE(T_CODEKIND,18,NULL,TO_CHAR(T_STATE)),207,DECODE(T_CODEKIND,1,NULL,TO_CHAR(T_STATE)),TO_CHAR(T_STATE))))
/