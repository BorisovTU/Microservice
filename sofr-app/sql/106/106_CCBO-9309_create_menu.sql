...
declare
  ...
  /* 
                            ...
                            Ь Шлюз
  */
  menu_path       varchar2(256) := 'Процедуры'; -- путь к пункту меню c разделителем \
  menu_item       varchar2(128) := 'Мониторинг импорта сделок из Кондор/АСУДР'; -- Имя пункта.
  menu_nameprompt varchar2(256) := 'Мониторинг импорта сделок из Кондор/АСУДР'; -- Описание.
  usermodule_name varchar2(128) := 'Мониторинг импорта сделок из Кондор/АСУДР'; -- Наименование пользовательского модуля 
  usermodule_file varchar2(128) := 'KondorDealImportMonitoring.mac'; -- Наименование макроса 
