declare
  l_code varchar2(100) := 'run_otc_deal_844';
  l_name varchar2(100) := 'Исполнение отложенных сделок в БОЦБ по 844 указу';
  l_file varchar2(100) := '844_run_otc_deals.mac';
  l_func varchar2(100) := 'RunDeal';
