...
declare
  ...
  */
  ...
  menu_item       varchar2(128) := 'Ручная выгрузка данных ДОФР'; -- Имя пункта.
  menu_nameprompt varchar2(256) := 'Ручная выгрузка данных для реконсиляции сделок ДОФР'; -- Описание.
  usermodule_name varchar2(128) := 'Ручная выгрузка данных для реконсиляции сделок ДОФР'; -- Наименование пользовательского модуля 
  usermodule_file varchar2(128) := 'dofr_unload_man.mac'; -- Наименование макроса 
